  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="relative z-10 p-6 flex flex-col md:flex-row justify-between items-center border-b border-white/10">
        <h1 className="text-4xl font-bold mb-4 md:mb-0 text-cyan-300">🎬 MOVIEX</h1>
        <WalletConnect />
      </nav>
      ...
      <main className="relative z-10 container mx-auto px-4 md:px-6 py-8 md:py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto mb-16">
          <Link href="/customer">
            <div className="panel p-6 md:p-8 hover:bg-white/10 transition-all cursor-pointer">
              ...
              <h3 className="text-2xl md:text-3xl font-bold mb-3 text-cyan-300">Customer Portal</h3>
              <p className="text-gray-300">
                Browse movies, buy tickets with PYUSD, and get your NFT tickets instantly
              </p>
              <div className="mt-4 flex items-center text-cyan-300 font-semibold">
          ...
          <Link href="/theater-owner">
            <div className="panel p-6 md:p-8 hover:bg-white/10 transition-all cursor-pointer">
              <div className="text-5xl md:text-6xl mb-4">🎬</div>
              <h3 className="text-2xl md:text-3xl font-bold mb-3 text-cyan-300">Theater Owner</h3>
              <p className="text-gray-300">
        ...
        <div className="max-w-6xl mx-auto mb-16">
          <div className="panel p-6 md:p-12">
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-center text-cyan-300">🚀 About MOVIEX</h3>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="panel p-6 hover:border-cyan-400/60 transition">
                ...
                <h4 className="text-xl font-bold mb-2 text-cyan-300">Secure NFT Tickets</h4>
              ...
              <div className="panel p-6 hover:border-cyan-400/60 transition">
                <div className="text-4xl mb-4">💰</div>
                <h4 className="text-xl font-bold mb-2 text-cyan-300">PYUSD Payments</h4>
                <p className="text-gray-400 text-sm">
              ...
              <div className="panel p-6 hover:border-cyan-400/60 transition">
                ...
                <h4 className="text-xl font-bold mb-2 text-cyan-300">100% On-Chain</h4>
                <p className="text-gray-400 text-sm">
        ...
        <div className="mt-12 md:mt-16 grid md:grid-cols-4 gap-4 md:gap-6 max-w-6xl mx-auto">
          <div className="panel p-6 text-center hover:border-cyan-400/50 transition">
            ...
            <h4 className="font-bold mb-2 text-cyan-300">QR Scanning</h4>
            <p className="text-xs md:text-sm text-gray-400">Easy ticket verification</p>
          </div>
          
          <div className="panel p-6 text-center hover:border-cyan-400/50 transition">
            <div className="text-3xl md:text-4xl mb-2">�</div>
            <h4 className="font-bold mb-2 text-cyan-300">Smart Escrow</h4>
            <p className="text-xs md:text-sm text-gray-400">Automated refunds</p>
          </div>

          <div className="panel p-6 text-center hover:border-cyan-400/50 transition">
            <div className="text-3xl md:text-4xl mb-2">📊</div>
            <h4 className="font-bold mb-2 text-cyan-300">Real-time Analytics</h4>
            <p className="text-xs md:text-sm text-gray-400">Live ticket data</p>
          </div>

          <div className="panel p-6 text-center hover:border-cyan-400/50 transition">
            <div className="text-3xl md:text-4xl mb-2">🎨</div>
            <h4 className="font-bold mb-2 text-cyan-300">NFT Collectibles</h4>
