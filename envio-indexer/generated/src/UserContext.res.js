...
function initEffect(params) {
  return function (effect, input) {
    return LoadLayer.loadEffect(params.loadManager, params.persistence, effect, {
                input: input,
                context: new Proxy(params, effectTraps),
                cacheKey: Utils.Hash.makeOrThrow(S$RescriptSchema.reverseConvertOrThrow(input, effect.input))
              }, params.inMemoryStore, params.isPreload, params.item);
  };
}

Caml_obj.update_dummy(effectTraps, {
      get: (function (params, prop) {
          switch (prop) {
            ...
            default:
              return Js_exn.raiseError("Invalid context access by '" + prop + "' property. Effect context doesn't allow access to storage.");
          }
        })
    });
...
exports.effectTraps = effectTraps;
