...
@genType
and entities = {
    @as("MovieManager_MovieAdded") movieManager_MovieAdded: entityStoreOperations<Entities.MovieManager_MovieAdded.t>,
    @as("MovieManager_ShowAdded") movieManager_ShowAdded: entityStoreOperations<Entities.MovieManager_ShowAdded.t>,
    @as("TicketEscrow_RefundProcessed") ticketEscrow_RefundProcessed: entityStoreOperations<Entities.TicketEscrow_RefundProcessed.t>,
    @as("TicketEscrow_TicketPurchased") ticketEscrow_TicketPurchased: entityStoreOperations<Entities.TicketEscrow_TicketPurchased.t>,
  }
  ...
  let entities = {
      movieManager_MovieAdded: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.MovieManager_MovieAdded)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.MovieManager_MovieAdded.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      movieManager_ShowAdded: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.MovieManager_ShowAdded)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.MovieManager_ShowAdded.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      ticketEscrow_RefundProcessed: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.TicketEscrow_RefundProcessed)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.TicketEscrow_RefundProcessed.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      ticketEscrow_TicketPurchased: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.TicketEscrow_TicketPurchased)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.TicketEscrow_TicketPurchased.t,
            >
          ),
          ~getKey=({id}) => id,
        )
